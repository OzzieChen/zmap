/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i /Users/ozziechen/ClionProjects/scanner/cmake-build-debug/src/zopt.ggo -F /Users/ozziechen/ClionProjects/scanner/cmake-build-debug/src/zopt 
...
#include "/Users/ozziechen/ClionProjects/scanner/cmake-build-debug/src/zopt.h"
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->shards_help = gengetopt_args_info_help[17] ;
  args_info->shard_help = gengetopt_args_info_help[18] ;
  args_info->source_port_help = gengetopt_args_info_help[20] ;
  args_info->source_ip_help = gengetopt_args_info_help[21] ;
  args_info->gateway_mac_help = gengetopt_args_info_help[22] ;
  args_info->source_mac_help = gengetopt_args_info_help[23] ;
  ...
  args_info->probe_args_help = gengetopt_args_info_help[28] ;
  args_info->list_probe_modules_help = gengetopt_args_info_help[29] ;
  args_info->output_fields_help = gengetopt_args_info_help[31] ;
  args_info->output_module_help = gengetopt_args_info_help[32] ;
  args_info->output_args_help = gengetopt_args_info_help[33] ;
  args_info->output_filter_help = gengetopt_args_info_help[34] ;
  args_info->list_output_modules_help = gengetopt_args_info_help[35] ;
  args_info->list_output_fields_help = gengetopt_args_info_help[36] ;
  args_info->verbosity_help = gengetopt_args_info_help[38] ;
  args_info->log_file_help = gengetopt_args_info_help[39] ;
  args_info->log_directory_help = gengetopt_args_info_help[40] ;
  args_info->metadata_file_help = gengetopt_args_info_help[41] ;
  args_info->status_updates_file_help = gengetopt_args_info_help[42] ;
  args_info->quiet_help = gengetopt_args_info_help[43] ;
  args_info->disable_syslog_help = gengetopt_args_info_help[44] ;
  args_info->notes_help = gengetopt_args_info_help[45] ;
  args_info->user_metadata_help = gengetopt_args_info_help[46] ;
  args_info->config_help = gengetopt_args_info_help[48] ;
  args_info->max_sendto_failures_help = gengetopt_args_info_help[49] ;
  args_info->min_hitrate_help = gengetopt_args_info_help[50] ;
  args_info->sender_threads_help = gengetopt_args_info_help[51] ;
  args_info->cores_help = gengetopt_args_info_help[52] ;
  args_info->ignore_invalid_hosts_help = gengetopt_args_info_help[53] ;
  args_info->help_help = gengetopt_args_info_help[54] ;
  args_info->version_help = gengetopt_args_info_help[55] ;
